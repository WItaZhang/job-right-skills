...
| skill | 做什么 | 状态 |
|---|---|---|
| `grill-direction` | 每轮按主题批量追问，写成 direction template；含义与强度分开确认 | 已实现；此前两次多轮访谈通过核心断言，最新批量与限时节奏待实际体验验证 |
...
访谈开场会说明产出、预计耗时与回答方式。默认一轮 6–8 个简短问题，可以只答部分或直接用语音说，下一轮沿已答主题追问。首轮访谈预计 20–30 分钟；语音以 30 分钟内收尾为目标，约 25 分钟开始整理，没有确认的内容保留在可恢复的草稿里。
